    ...
    if (!accountId) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">Sin Cuenta Conectada</h2>
                <p className="text-gray-400">Por favor, conecta una cuenta de Instagram en la pestaña Perfil para ver información de tendencias.</p>
            </div>
        );
    }
        ...
        <div className="space-y-6 pb-20">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-400 mt-1">Descubre qué está de moda en tu nicho</p>
                </div>
                <button
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">{(tag.count / 1000000).toFixed(1)}M publicaciones</p>
                                    </div>
                                </div>
                        ...
                        {allContentIdeas.length > 0 ? (
                            allContentIdeas.map((idea: string, index: number) => (
                                ...
                                >
                                    ...
                                    <p className="text-xs text-gray-400 mt-1">Tendencia en tu industria</p>
                                </motion.div>
                            ))
                        ) : (
                            <p className="text-gray-400">No hay sugerencias disponibles. Intenta actualizar tu Perfil de Negocio.</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            {/* Trending Topics */}
            <div className="glass-card p-6">
                <h3 className="text-xl font-semibold mb-4">Temas en Tendencia</h3>
